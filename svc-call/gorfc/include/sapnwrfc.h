...
typedef struct _RFC_ATTRIBUTES
{
    ...
    SAP_UC partnerIP[15+1];          ///< Partner IP Address
    SAP_UC partnerIPv6[45+1];          ///< Partner IPv6 Address
 ...
 *
 * If the external program is the receiver of the bgRFC unit, you can use RfcGetUnitAttributes()
...
extern "C"
{
	 ...
	 * this <A HREF="http://www.sdn.sap.com/irj/sdn/index?rid=/library/uuid/5070f62a-6acd-2c10-8cb5-858ef06adbb9">
	 * article</A>.
     * 
     * \in typeHandle The type description.
	 ...
	 * Calling #RfcEnableAbapClassException() allows the RFC call invoked over this function handle to be able to 
     * support the ABAP class exception, if the target backend supports it.
	 * \in funcHandle  function module data container .
     ...
     * the same that's used for the RFC call itself. 
	 * \out *errorInfo Should always return successfully.
	 * \return RFC_RC
	 */
	 ...
	 *
	 * R/3 Systems from kernel release 7.11 on support ABAP class exception.
	 * Typically, a RFC server uses function to is called by RFC server ll invoked over this function handle to be able to 
     * support the ABAP class exception, if the target backend supports it.
	 * 
	 * \in funcHandle   function module data container.
	 ...
	 * \ingroup repository
	 *
	 * Structure containing the error occurred during metadata query. 
	 */
	 ...
	 * \ingroup repository
	 *
	 * RFC_METADATA_OBJ_TYPE is either function or type or class and is used in RfcGetMetadataQueryFailedEntry()
	 * and RfcGetMetadataQuerySucceededEntry().
	 */
